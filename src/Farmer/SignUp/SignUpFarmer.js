    ...
    <div className="container-fluid">
      <div className="row justify-content-around">
        ...
        <div className="col-md-6 col-11 mt-5 align-items-center ">
          <h3 className="div1" id="signup">
            Create Your AFL Account
          </h3>
          <div className="row mb-3 mt-2">
            <label for="colFormLabel" className="col-sm-3 col-form-label mt-3">
              Username
            </label>
            ...
            <Button
              variant="primary"
              type="button"
              className="ms-4 mb-3 mt-3 col-sm-10"
              onClick={signup}
            >
              Sign Up
            </Button>
